<aside class="menu">
    ...
    <ul class="menu-list">
        <li><a class="{{Route::currentRouteName() == 'student.cabinet.index' ? 'is-active':''}}"
               href="{{route('student.cabinet.index')}}">Мой профиль</a></li>
        <li><a class="{{Route::currentRouteName() == 'student.cabinet.settings' ? 'is-active':''}}"
               href="{{route('student.cabinet.settings')}}">Настройки</a></li>
